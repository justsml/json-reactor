!function(root, factory) {
    "object" == typeof exports && "object" == typeof module ? module.exports = factory(require("react"), require("lodash.isequal"), require("react-dnd"), require("react-dnd-html5-backend"), require("react-virtualized")) : "function" == typeof define && define.amd ? define([ "react", "lodash.isequal", "react-dnd", "react-dnd-html5-backend", "react-virtualized" ], factory) : "object" == typeof exports ? exports.ReactSortableTree = factory(require("react"), require("lodash.isequal"), require("react-dnd"), require("react-dnd-html5-backend"), require("react-virtualized")) : root.ReactSortableTree = factory(root.react, root["lodash.isequal"], root["react-dnd"], root["react-dnd-html5-backend"], root["react-virtualized"]);
	 ...
	 */
        ...
        function addNodeAtDepthAndIndex(_ref19) {
            ...
            // Get all descendants
            var insertedTreeIndex = null, childIndex = currentIndex + 1, newChildren = node.children;
            "function" != typeof newChildren && (newChildren = newChildren.map(function(child, i) {
                ...
                childIndex = mapResult.nextIndex, mapResult.node;
            }));
            var result = {
                node: _extends({}, node, {
                    children: newChildren
	 ...
	 */
        function insertNode(_ref20) {
            var treeData = _ref20.treeData, targetDepth = _ref20.depth, minimumTreeIndex = _ref20.minimumTreeIndex, newNode = _ref20.newNode, _ref20$ignoreCollapse = _ref20.ignoreCollapsed, ignoreCollapsed = void 0 === _ref20$ignoreCollapse || _ref20$ignoreCollapse, _ref20$expandParent = _ref20.expandParent, expandParent = void 0 !== _ref20$expandParent && _ref20$expandParent;
	 ...
	 */
        function getTreeFromFlatData(_ref23) {
            var flatData = _ref23.flatData, getKey = _ref23.getKey, getParentKey = _ref23.getParentKey, rootKey = _ref23.rootKey;
            if (!flatData) return [];
	...
	*/
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _reactDnd = __webpack_require__(22), _reactDndHtml5Backend = __webpack_require__(23), _reactDndHtml5Backend2 = _interopRequireDefault(_reactDndHtml5Backend), _itemTypes = __webpack_require__(7), _itemTypes2 = _interopRequireDefault(_itemTypes), _treeDataUtils = __webpack_require__(1), nodeDragSource = {
            ...
            hover: function(props, monitor, component) {
                var _this = this, cancelAnimationFrame = window.cancelAnimationFrame || function(timeout) {
                    return clearTimeout(timeout);
                }, requestAnimationFrame = window.requestAnimationFrame || function(func) {
                    return setTimeout(func, 1e3 / 60);
                };
                // If already scrolling, stop the previous scroll loop
                this.lastScroll && (cancelAnimationFrame(this.lastScroll), this.lastScroll = null, 
                clearTimeout(this.removeTimeout));
                var slideRegionSize = component.props.slideRegionSize, _monitor$getClientOff = monitor.getClientOffset(), dragXOffset = _monitor$getClientOff.x, dragYOffset = _monitor$getClientOff.y, _component$containerR = component.containerRef.getBoundingClientRect(), containerTop = _component$containerR.top, containerBottom = _component$containerR.bottom, containerLeft = _component$containerR.left, containerRight = _component$containerR.right, yScrollDirection = 0, yScrollMagnitude = 0, fromTop = dragYOffset - slideRegionSize - Math.max(containerTop, 0);
                if (fromTop <= 0) // Move up
                yScrollDirection = -1, yScrollMagnitude = Math.sqrt(-1 * fromTop); else {
                    var fromBottom = dragYOffset + slideRegionSize - Math.min(containerBottom, window.innerHeight);
                    fromBottom >= 0 && (// Move down
                    yScrollDirection = 1, yScrollMagnitude = Math.sqrt(fromBottom));
                }
                var xScrollDirection = 0, xScrollMagnitude = 0, fromLeft = dragXOffset - slideRegionSize - Math.max(containerLeft, 0);
                if (fromLeft <= 0) // Move up
                xScrollDirection = -1, xScrollMagnitude = Math.ceil(Math.sqrt(-1 * fromLeft)); else {
                    var fromRight = dragXOffset + slideRegionSize - Math.min(containerRight, window.innerWidth);
                    fromRight >= 0 && (// Move down
                    xScrollDirection = 1, xScrollMagnitude = Math.ceil(Math.sqrt(fromRight)));
                }
                // Don't do anything if there is no scroll operation
                if (0 !== xScrollDirection || 0 !== yScrollDirection) {
                    ...
                    this.removeTimeout = setTimeout(function() {
                        cancelAnimationFrame(_this.lastScroll), _this.lastScroll = null;
                    }, 20), // Start the scroll loop
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _extends = Object.assign || function(target) {
            ...
            return target;
        }, _react = __webpack_require__(4), _react2 = _interopRequireDefault(_react), _browserUtils = __webpack_require__(11), _nodeRendererDefault = __webpack_require__(18), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), styles = _nodeRendererDefault2["default"];
        ...
        var NodeRendererDefault = function(_ref) {
            ...
            }, toggleChildrenVisibility && node.children && node.children.length > 0 && _react2["default"].createElement("div", null, _react2["default"].createElement("div", {
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(4), _react2 = _interopRequireDefault(_react), _reactVirtualized = __webpack_require__(24), _lodash = __webpack_require__(21), _lodash2 = _interopRequireDefault(_lodash);
        __webpack_require__(17);
        var _treeNode = __webpack_require__(10), _treeNode2 = _interopRequireDefault(_treeNode), _nodeRendererDefault = __webpack_require__(8), _nodeRendererDefault2 = _interopRequireDefault(_nodeRendererDefault), _treeDataUtils = __webpack_require__(1), _genericUtils = __webpack_require__(12), _defaultHandlers = __webpack_require__(5), _dragAndDropUtils = __webpack_require__(6), _reactSortableTree = __webpack_require__(19), _reactSortableTree2 = _interopRequireDefault(_reactSortableTree), ReactSortableTree = function(_Component) {
            function ReactSortableTree(props) {
                ...
                return _this.nodeContentRenderer = (0, _dragAndDropUtils.dndWrapSource)(props.nodeContentRenderer), 
                _this.state = {
            ...
            return _inherits(ReactSortableTree, _Component), _createClass(ReactSortableTree, [ {
                ...
                value: function(_ref3) {
                    var node = _ref3.node, depth = _ref3.depth, minimumTreeIndex = _ref3.minimumTreeIndex, treeData = (0, 
                ...
                key: "scrollBy",
                value: function(x, y) {
                    this.containerRef && (0 !== x && (this.containerRef.getElementsByClassName(_reactSortableTree2["default"].virtualScrollOverride)[0].scrollLeft += x), 
                    0 !== y && (this.scrollTop = this.scrollTop ? this.scrollTop + y : y, this.setState({
                        scrollToPixel: this.scrollTop
                    })));
                }
            }, {
                key: "render",
                value: function() {
                    var _this3 = this, _props = this.props, style = _props.style, className = _props.className, innerStyle = _props.innerStyle, rowHeight = _props.rowHeight, _connectDropTarget = _props._connectDropTarget, _state = this.state, rows = _state.rows, searchMatches = _state.searchMatches, searchFocusTreeIndex = _state.searchFocusTreeIndex, scrollToPixel = _state.scrollToPixel, matchKeys = {};
                    ...
                    return _connectDropTarget(_react2["default"].createElement("div", {
                ...
                value: function(_ref13, listIndex, key, style, getPrevRow, matchKeys) {
                    var node = _ref13.node, path = _ref13.path, lowerSiblingCounts = _ref13.lowerSiblingCounts, treeIndex = _ref13.treeIndex, NodeContentRenderer = this.nodeContentRenderer, nodeKey = path[path.length - 1], isSearchMatch = nodeKey in matchKeys, isSearchFocus = isSearchMatch && matchKeys[nodeKey] === this.props.searchFocusOffset, nodeProps = this.props.generateNodeProps ? this.props.generateNodeProps({
                        node: node,
                        path: path,
                        lowerSiblingCounts: lowerSiblingCounts,
                        treeIndex: treeIndex,
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _extends = Object.assign || function(target) {
            ...
            return target;
        }, _react = __webpack_require__(4), _react2 = _interopRequireDefault(_react), _dragAndDropUtils = __webpack_require__(6), _treeNode = __webpack_require__(20), _treeNode2 = _interopRequireDefault(_treeNode), TreeNode = function(_ref) {
